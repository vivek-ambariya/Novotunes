...
SECRET_KEY = os.getenv('SECRET_KEY', 'a-default-secret-key-for-dev-only')
...
# In production, you should be more specific, e.g., CORS_ALLOWED_ORIGINS = ["http://localhost:3000"]
...
# MongoDB Config (Raw PyMongo usage for unstructured data like Queue/DeepFace results)
import pymongo
